...
public:
	...
	{
		vector<int> indegree(vertices.size(),0); // indegree를 Vertex에 저장할 수도 있습니다.
		// TODO:
...
int main()
{
...

	{
		...
		while (!my_stack.empty())
		{
			cout << values[my_stack.top()->index] << " " << my_stack.top()->index << endl;
			my_stack.pop();
		}
	}
